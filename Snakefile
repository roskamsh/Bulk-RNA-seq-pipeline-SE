...
SAMPLES, = glob_wildcards("samples/raw/{sample}.fq.gz")
...
rule all:
    input:
        ...
        expand("samples/fastqc/{sample}/{sample}_P_t_fastqc.zip", sample = SAMPLES),
        expand("samples/fastqscreen/{sample}/{sample}_P_t_screen.{fastqscreen_ext}", sample=SAMPLES, fastqscreen_ext=fastqscreen_ext),
